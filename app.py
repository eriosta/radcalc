...
if nav_selection == 'Home':
    ...
    st.write("""
    This MR Elastography App is intended for educational and informational purposes only. The results and outputs generated by this app should not be used as a substitute for professional medical advice, diagnosis, or treatment. Always consult with a qualified healthcare provider regarding any medical condition or treatment recommendations. The developers and maintainers of this application accept no responsibility for any consequences resulting directly or indirectly from the use of this application.
    """)
